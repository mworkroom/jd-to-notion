...
const elements = {
  googleSheetsReadiness: document.querySelector('#google-sheets-readiness'),
  googleSheetsTarget: document.querySelector('#google-sheets-target'),
  googleSheetsUnsynced: document.querySelector('#google-sheets-unsynced'),
  googleSheetsOutputRows: document.querySelector('#google-sheets-output-rows'),
  googleSheetsLastSynced: document.querySelector('#google-sheets-last-synced'),
  googleSheetsStatus: document.querySelector('#google-sheets-status'),
  googleSheetsPreview: document.querySelector('#google-sheets-preview'),
  googleSheetsPreviewRows: document.querySelector('#google-sheets-preview-rows'),
  googleSheetsHeld: document.querySelector('#google-sheets-held'),
  googleSheetsResult: document.querySelector('#google-sheets-result'),
  refreshGoogleSheetsButton: document.querySelector('#refresh-google-sheets-button'),
  syncGoogleSheetsButton: document.querySelector('#sync-google-sheets-button'),
...
elements.refreshGoogleSheetsButton.addEventListener('click', () => refreshGoogleSheetsPanel());
elements.syncGoogleSheetsButton.addEventListener('click', syncGoogleSheets);
...
async function refreshGoogleSheetsPanel({ preserveResult = false } = {}) {
  ...
  try {
    ...
    const previewResponse = await fetch('/api/google-sheets/preview', { method: 'POST' });
...
function createGoogleSheetsPreviewRow(row, index) {
  ...
  const programmes = document.createElement('p');
